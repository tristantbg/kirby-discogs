...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"helpers/validators.js":[function(require,module,exports) {
"use strict";
...
},{}],"components/discogsField.vue":[function(require,module,exports) {
"use strict";
...
var _validators = require("../helpers/validators.js");
...
var _default = {
  ...
  computed: {
    ...
    syncFailed: function syncFailed() {
...
exports.default = _default;
        var $1aa659 = exports.default || module.exports;
      
      if (typeof $1aa659 === 'function') {
        $1aa659 = $1aa659.options;
      }
    
        /* template */
        Object.assign($1aa659, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", [
    _c(
      "div",
      { staticClass: "k-field", attrs: { "data-type": "discogs" } },
      [
        _c(
          "k-autocomplete",
          {
          ...
          [
            _c("input", {
              attrs: { type: "text", placeholder: "Search release…" },
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$1aa659', $1aa659);
          } else {
            api.reload('$1aa659', $1aa659);
          }
        }
...
},{"../helpers/validators.js":"helpers/validators.js","_css_loader":"../../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/discogsInput.vue":[function(require,module,exports) {
"use strict";
  ...
  methods: {
    ...
    loadEmbedScripts: function loadEmbedScripts() {
      ...
      if (window.instgrm) {
        ...
        var _discogs = document.createElement('script');

        _discogs.src = 'https://www.instagram.com/discogs.js';
        document.body.appendChild(_discogs);
      }
    },
    isValidUrl: function isValidUrl(value) {
      if (!(0, _validators.isUrl)(value)) return false;
      if (this.provider && !(0, _validators.matchProvider)(value, this.provider)) return false;
      return true;
    }
  }
};
exports.default = _default;
        var $055b66 = exports.default || module.exports;
      
      if (typeof $055b66 === 'function') {
        $055b66 = $055b66.options;
      }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$055b66', $055b66);
          } else {
            api.reload('$055b66', $055b66);
          }
        }
...
},{"../helpers/validators.js":"helpers/validators.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _discogsField = _interopRequireDefault(require("./components/discogsField.vue"));

var _discogsInput = _interopRequireDefault(require("./components/discogsInput.vue"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

panel.plugin('tristantbg/discogs', {
  fields: {
    discogs: _discogsField.default
  },
  components: {
    'k-discogs-input': _discogsInput.default
  }
});
},{"./components/discogsField.vue":"components/discogsField.vue","./components/discogsInput.vue":"components/discogsInput.vue"}],"../../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
